...
jQuery(function ($) {
    ...
    new Chart(document.getElementById("pieEdu").getContext("2d")).Pie(education, options);
    new Chart(document.getElementById("pieWork").getContext("2d")).Pie(work, options);
    new Chart(document.getElementById("pieDemo").getContext("2d")).Pie(demographics, options);
